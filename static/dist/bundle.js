var e;const Projects=(t=>{let s=t=>{fetch(Apis.apiUri).then(t=>t.json()).then(t=>{$("#apisProjectsListBtn").addClass("actived"),$("#pinnedProjectsListBtn").removeClass("actived"),$("#cratesProjectsListBtn").removeClass("actived"),$("#featuredProjectsListBtn").removeClass("actived"),$("#projectsList").empty(),t.list.forEach(t=>{$("#projectsList").append(`
                ...
                `)}),$("#featured").show()})};return{apiUri:a,username:s,cratesURI:o,cratesPage:"https://crates.io/crates/",projectsUri:i,apis:()=>n(),crates:()=>d(),pinned:()=>l(),projects:()=>f(),checkApi:()=>p(),colors:t=>r(t),downloadPdf:()=>h()}})(),ScrollTo={top(t){history.pushState(null,null,window.location.href.split("#")[0]),window.scroll({top:0,left:0,behavior:"smooth"})},checkScroll(t){let s=document.getElementById("scrollToTopBtn");window.scrollY>0?s.style.display="block":s.style.display="none"}};