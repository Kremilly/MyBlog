var e;const Mermaid=(t=>{let s=t=>{mermaid.initialize({theme:"dark",securityLevel:"loose"});let s=document.querySelectorAll(".language-mermaid");s.forEach(t=>{t.classList.remove("language-mermaid"),t.classList.add("diagram-mermaid")}),s.forEach(t=>{let s=document.createElement("div");s.classList.add("mermaid"),s.textContent=t.textContent,t.textContent="",t.appendChild(s),mermaid.init(void 0,s)})};s()})(),Projects=(t=>{let s=t=>{fetch(Apis.apiUri).then(t=>t.json()).then(t=>{$("#apisProjectsListBtn").addClass("actived"),$("#pinnedProjectsListBtn").removeClass("actived"),$("#cratesProjectsListBtn").removeClass("actived"),$("#featuredProjectsListBtn").removeClass("actived"),$("#projectsList").empty(),t.list.forEach(t=>{$("#projectsList").append(`
